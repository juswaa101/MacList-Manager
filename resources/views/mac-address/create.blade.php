...
@section('title', 'MAC Addresses - Create')

@section('content')
    <div class="container py-4">
        <h1 class="h3 mb-4">Create MAC Address</h1>
        ...
        <form action="{{ route('mac-addresses.store') }}" method="POST" novalidate>
            @csrf
            ...
            <div class="mb-3">
                ...
                <select name="type" id="type" class="form-select @error('type') is-invalid @enderror" required>
                    ...
                    @foreach (App\Enum\MacTypeEnum::values() as $macType)
                        <option value="{{ $macType }}" {{ old('type') == $macType ? 'selected' : '' }}>
